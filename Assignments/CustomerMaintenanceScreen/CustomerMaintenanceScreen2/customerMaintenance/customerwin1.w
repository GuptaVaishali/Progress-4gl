...
DEFINE FRAME DEFAULT-FRAME
     btnRadio AT ROW 2.67 COL 118 NO-LABEL WIDGET-ID 2
     btnSubmit AT ROW 7.43 COL 110 WIDGET-ID 6
     btnExit AT ROW 7.43 COL 128 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 264 BY 21.95 WIDGET-ID 100.
...
DEFINE FRAME search-frame
     ...
     btnReturn AT ROW 12.95 COL 108 WIDGET-ID 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 13 ROW 6.71 SCROLLABLE 
         TITLE "Search Customer" WIDGET-ID 200.

DEFINE FRAME new-frame
     FCustNum AT ROW 1.95 COL 19 COLON-ALIGNED WIDGET-ID 4
     FName AT ROW 1.95 COL 49 COLON-ALIGNED WIDGET-ID 6
     FCity AT ROW 1.95 COL 79 COLON-ALIGNED WIDGET-ID 8
     FState AT ROW 1.95 COL 109 COLON-ALIGNED WIDGET-ID 10
     FCountry AT ROW 3.86 COL 19 COLON-ALIGNED WIDGET-ID 12
     FAddress AT ROW 3.86 COL 49 COLON-ALIGNED WIDGET-ID 14
     FAddress2 AT ROW 3.86 COL 79 COLON-ALIGNED WIDGET-ID 16
     FPostalCode AT ROW 3.86 COL 109 COLON-ALIGNED WIDGET-ID 18
     FContact AT ROW 5.76 COL 19 COLON-ALIGNED WIDGET-ID 20
     FSalesRep AT ROW 5.76 COL 49 COLON-ALIGNED WIDGET-ID 40
     FPhone AT ROW 5.76 COL 79 COLON-ALIGNED WIDGET-ID 24
     FCreditLimit AT ROW 5.76 COL 109 COLON-ALIGNED WIDGET-ID 26
     FBalance AT ROW 7.67 COL 19 COLON-ALIGNED WIDGET-ID 28
     FTerms AT ROW 7.67 COL 49 COLON-ALIGNED WIDGET-ID 30
     FDiscount AT ROW 7.67 COL 79 COLON-ALIGNED WIDGET-ID 32
     FComments AT ROW 7.67 COL 109 COLON-ALIGNED WIDGET-ID 34
     btnSave AT ROW 9.33 COL 50 WIDGET-ID 36
     btnBack AT ROW 9.33 COL 71 WIDGET-ID 38
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 59 ROW 9.57
         SIZE 134 BY 10.71
         TITLE "Insert Customer"
         DEFAULT-BUTTON btnBack WIDGET-ID 500.
...
/* REPARENT FRAME */
ASSIGN FRAME new-frame:FRAME = FRAME DEFAULT-FRAME:HANDLE
...
ASSIGN XXTABVALXX = FRAME search-frame:MOVE-AFTER-TAB-ITEM (btnRadio:HANDLE IN FRAME DEFAULT-FRAME)
       XXTABVALXX = FRAME search-frame:MOVE-BEFORE-TAB-ITEM (btnSubmit:HANDLE IN FRAME DEFAULT-FRAME)
       XXTABVALXX = FRAME new-frame:MOVE-AFTER-TAB-ITEM (btnExit:HANDLE IN FRAME DEFAULT-FRAME)
/* END-ASSIGN-TABS */.
...
/* BROWSE-TAB brCust btnSearch search-frame */
ASSIGN 
