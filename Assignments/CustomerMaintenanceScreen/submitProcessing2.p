...
DO:
    ...
    DO:
        DISPLAY viCnum vcName vcCountry vcAddress vcAddress2 vcCity vcState vcPostalCode vcContact vcSalesRep vcPhone vdCreditLimit vdBalance vcTerms viDiscount vcComments 
            WITH FRAME search-frame 2 COLUMNS VIEW-AS DIALOG-BOX TITLE "Display Customer".
        ...
        ON CHOOSE OF btnUpdate IN FRAME search-frame
        DO:
            ...
            ELSE
            DO:
                ASSIGN customer.country      = vcCountry:SCREEN-VALUE IN FRAME search-frame
                       ...
                       customer.discount     = DECIMAL ( TRIM ( viDiscount:SCREEN-VALUE IN FRAME search-frame, "%" ) )
                       customer.comments     = vcComments:SCREEN-VALUE.
                       
                MESSAGE "RECORD UPDATED SUCCESSFULLY" VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.  
            END.
        END.     /* BTNUPDATE TRIGGER END */
                   
        ENABLE ALL EXCEPT viCnum WITH FRAME search-frame.  
