...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 FFilePath btnReadXml 
...
DEFINE FRAME DEFAULT-FRAME
     ...
     btnReadXml AT ROW 4.81 COL 25 WIDGET-ID 22
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* xmlRead */
DO:
...
&Scoped-define SELF-NAME btnReadXml
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnReadXml C-Win
ON CHOOSE OF btnReadXml IN FRAME DEFAULT-FRAME /* Read  XML */
DO:
    ...
    DO ON ERROR UNDO,RETRY:
         ...
         DO:
            ...
            UNDO getfile, RETRY getfile.
         END.      
         ELSE IF SUBSTRING(vcFilePath,(R-INDEX(vcFilePath,".")) + 1) NE "xml" THEN
         DO:
            MESSAGE "PLEASE ENTER XML FILE PATH" VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
            UNDO  getfile, RETRY getfile.
         END.
         ...
         DO:
            ...
            lReturn = TEMP-TABLE ttCustomer:READ-XML(cSourceType, cFile, cReadMode, cSchemaLocation, lOverrideDefaultMapping,
                                                        cVerifySchemaMode).
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 RECT-2 FFilePath btnReadXml 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
