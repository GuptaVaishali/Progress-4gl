...
DEFINE VARIABLE cFile            AS CHARACTER NO-UNDO.     //XML file name
DEFINE VARIABLE lFormatted       AS LOGICAL   NO-UNDO.
DEFINE VARIABLE cEncoding        AS CHARACTER NO-UNDO.
DEFINE VARIABLE cSchemaLocation  AS CHARACTER NO-UNDO.
DEFINE VARIABLE lWriteSchema     AS LOGICAL   NO-UNDO.     //schema of temp-table
...
ON END-ERROR OF C-Win /* WriteXML */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* WriteXML */
DO:
...
ON CHOOSE OF btnGenerateFile IN FRAME DEFAULT-FRAME /* Generate XML */
DO:
   ...
   DO:
       ...
       lRetOk  = TEMP-TABLE ttCustomer:WRITE-XML(cTargetType, cFile, lFormatted,
