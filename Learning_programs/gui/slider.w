...
&Scoped-Define ENABLED-OBJECTS SLIDER-1 
...
DEFINE VARIABLE SLIDER-1 AS INTEGER INITIAL 0 
     VIEW-AS SLIDER MIN-VALUE 0 MAX-VALUE 100 HORIZONTAL LARGE-TO-SMALL 
     TIC-MARKS BOTH FREQUENCY 25
     SIZE 31 BY 7.86 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     SLIDER-1 AT ROW 5.76 COL 30 NO-LABEL WIDGET-ID 2
